...
// ga('create', 'INSERT UA ACCOUNT #', 'auto');
// ga('send', 'pageview');

//Happy Scroll template scripts - from http://www.bootply.com/100702
...
//End happy scroll scripts

//Full image sizing
$(window).load(function() {

	//Make wrappers square
	...
	//Set up each image
	$.each($('.full-image'), function(index, element){		
		if($(element).width() >= $(element).height()) {
			$(element).addClass('height-constrain');
		} else {
			$(element).addClass('width-constrain');
		}
	});
